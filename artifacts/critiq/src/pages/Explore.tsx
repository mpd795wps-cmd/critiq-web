      ...
      <div className="mx-auto min-h-screen w-full max-w-[480px] bg-[#f8faf8] pb-28">
        ...
        <section className="mt-9 px-5">
          <div className="mb-4">
            ...
            <p className="mt-1 text-sm text-[#7a867f]">商品カテゴリを選択してください。</p>
          </div>
            ...
            {categories.map((category) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-[#a1ada6] transition group-hover:translate-x-0.5">→</span>
                </div>
                <p className="mt-4 font-bold text-[#274b3e]">{category.name}</p>
              </Link>
            ))}
          </div>
        </section>
